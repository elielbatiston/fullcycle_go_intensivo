...
func TestGivenAnValidParams_WhenICallNewOrder_ThenShouldReceiveCreateOrderWithAllParams(t *testing.T) {
	order := Order{
		ID:    "123",
		Price: 10.0,
		Tax:   2.0,
...
func TestGivenAnValidParams_WhenICallNewOrderFunc_ThenShouldReceiveCreateOrderWithAllParams(t *testing.T) {
...
func TestGivenAPriceAndTax_WhenICallCalculatePrice_ThenIShouldSetFinalPrice(t *testing.T) {
	...
	assert.Nil(t, err)
	assert.Nil(t, order.CalculeteFinalPrice())
